        ...
        <nav className='px-5 lg:px-12 py-2 text-slate-50 z-50'>
            <div className='flex flex-row justify-between items-center mx-auto'>
                ...
                <div className='flex flex-row-reverse lg:flex-row lg:justify-between items-center'>
                    ...
                    <menu className={isOpen ? 'absolute lg:static w-64 right-0 top-12 z-50' : 'absolute lg:static right-[-2000px] w-64'}>
                        <ul className='block lg:flex lg:flex-row text-md font-medium px-5 py-1 lg:px-0 lg:py-0 mt-2 lg:mt-0 bg-white lg:bg-transparent shadow-md lg:shadow-none'>
                            ...
                            <li className='mb-3 lg:mb-0'><Link className='hover:text-slate-200 lg:text-slate-50 text-slate-900 text-md font-medium py-2 px-2 mx-2 duration-500 ' to='/'>Listings</Link></li>
                            <li className='mb-3 lg:mb-0'><Link className='hover:text-slate-200 lg:text-slate-50 text-slate-900 text-md font-medium py-2 px-2 mx-2 duration-500 ' to='/'>Agents</Link></li>
                            <li className='mb-3 lg:mb-0'><Link className='hover:text-slate-200 lg:text-slate-50 text-slate-900 text-md font-medium py-2 px-2 mx-2 duration-500 ' to='/'>News</Link></li>
                            ...
                            <li className='mb-3 lg:mb-0'><Link className='hover:text-slate-200 lg:text-slate-50 text-slate-900 text-md font-medium py-2 px-2 mx-2 duration-500 block lg:hidden' to='/'>Add Listing</Link></li>
                        </ul>
                    </menu>
                </div>
                ...
                <div className='text-md font-medium hidden lg:flex lg:flex-row items-center'>
                    <button className='py-1 px-5 hover:border-slate-50 hover:rounded-full hover:bg-slate-100 hover:text-slate-900 duration-200 mr-5'>
